...
public class AdresseTestService {
	...
	public void un_abonne_avec_une_adresse_principale_active_en_Pologne(String active, String pay) {
		assertEquals("active", active);
	}

	@Alors("​l'adresse de l'abonné modifiée est enregistrée sur l'ensemble des contrats de l'abonné")
	public void l_abonne_modifiee_est_enregistree_sur_l_abonne(String string,String string2) { 
		if (pays=="France") {
	...
	public void le_conseiller_connecte_a_EC_modifie_l_abonne_avec_date_d_effet(String canal,
			String condition) {
